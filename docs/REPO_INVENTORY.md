...
- `retain_as_test_only`: 44
- `review_for_archive`: 132
...
| --- | --- | --- | --- | --- | --- |
| `docs/archive/NEXT_STEPS.md` | docs | non_production | review_for_archive | archive | - |
| `docs/archive/PROJECT_STATUS.md` | docs | non_production | review_for_archive | archive | - |
| `src/universal_visual_os_agent/actions/dry_run.py` | actions | supporting | review_for_split | - | oversized_module |
| `src/universal_visual_os_agent/actions/dry_run_models.py` | actions | supporting | review_for_split | - | oversized_module |
...
| `src/universal_visual_os_agent/actions/safe_click.py` | actions | supporting | review_for_cycle_isolation | - | cycle_member, oversized_module, high_internal_import_count:10, high_cross_package_import_count:5 |
...
| `src/universal_visual_os_agent/ai_architecture/cloud_planner.py` | ai_contracts | supporting | review_for_split | - | oversized_module, high_internal_import_count:12, high_cross_package_import_count:6 |
...
| `src/universal_visual_os_agent/ai_architecture/escalation_engine.py` | ai_contracts | supporting | review_for_split | - | oversized_module |
| `src/universal_visual_os_agent/ai_architecture/local_visual_resolver.py` | ai_contracts | supporting | review_for_split | - | oversized_module |
...
| `.tmp_test_artifacts/133799fcc8554dd1b255965c4e3c4234/agent.sqlite3` | support | non_production | review_for_archive | archive | - |
...
| `.tmp_test_artifacts/47738f93f97d4b82bbe15bc0f55ec4d3/agent.sqlite3` | support | non_production | review_for_archive | archive | - |
...
| `.tmp_test_artifacts/61f8a6fc9f244bfe8c82fae858955740/agent.sqlite3` | support | non_production | review_for_archive | archive | - |
...
| `.tmp_test_artifacts/718a94ae228d4586b7777a24ff5d6562/agent.sqlite3` | support | non_production | review_for_archive | archive | - |
...
| `.tmp_test_artifacts/76bda0e71d2444d59454f4d1633eae3f/agent.sqlite3` | support | non_production | review_for_archive | archive | - |
| `.tmp_test_artifacts/7883aec6937e4308bd219a133573c8cc/agent.sqlite3` | support | non_production | review_for_archive | archive | - |
| `.tmp_test_artifacts/793faa5d58644f1d9ef343d75e531291/agent.sqlite3` | support | non_production | review_for_archive | archive | - |
...
| `.tmp_test_artifacts/8127b6b4d8084fbaaca9aae79b6c0503/agent.sqlite3` | support | non_production | review_for_archive | archive | - |
| `.tmp_test_artifacts/82a1c46645314128b9ecf1951932b3bb/agent.sqlite3` | support | non_production | review_for_archive | archive | - |
| `.tmp_test_artifacts/83249e3055c449799482465dcb4b5e65/agent.sqlite3` | support | non_production | review_for_archive | archive | - |
...
| `.tmp_test_artifacts/8a93dda6256d4c1cbd812ea7379a7d44/agent.sqlite3` | support | non_production | review_for_archive | archive | - |
...
| `.tmp_test_artifacts/8f3cfe3fdc7d43c3aebf10d25c733a5f/agent.sqlite3` | support | non_production | review_for_archive | archive | - |
...
| `.tmp_test_artifacts/b18835ca61e94f73a5a0e3bee0fa5a61/agent.sqlite3` | support | non_production | review_for_archive | archive | - |
...
| `.tmp_test_artifacts/bf324ebfc293467f918e6e994309245a/agent.sqlite3` | support | non_production | review_for_archive | archive | - |
...
| `.tmp_test_artifacts/c590bc4cf476449798bb3c57727d9108/agent.sqlite3` | support | non_production | review_for_archive | archive | - |
...
| `.tmp_test_artifacts/f3f0a43f848341a29d7db716024e7807/agent.sqlite3` | support | non_production | review_for_archive | archive | - |
...
| `src/universal_visual_os_agent/semantics/__init__.py` | semantics | critical | keep | - | high_internal_import_count:14, facade_reexport_surface |
| `src/universal_visual_os_agent/semantics/building.py` | semantics | critical | review_for_split | - | oversized_module |
| `src/universal_visual_os_agent/semantics/candidate_exposure.py` | semantics | critical | review_for_split | - | oversized_module |
| `src/universal_visual_os_agent/semantics/candidate_generation.py` | semantics | critical | review_for_split | - | oversized_module |
| `src/universal_visual_os_agent/semantics/candidate_scoring.py` | semantics | critical | review_for_split | - | oversized_module |
...
| `docs/CONTEXT_BOUNDARIES.json` | docs | non_production | keep | - | - |
| `docs/CONTEXT_BOUNDARIES.md` | docs | non_production | keep | - | - |
| `docs/CONTEXT_PACKS.json` | docs | non_production | keep | - | - |
| `docs/CONTEXT_PACKS.md` | docs | non_production | keep | - | - |
| `docs/README.md` | docs | non_production | keep | - | - |
| `docs/REPO_INVENTORY.json` | docs | non_production | keep | - | - |
| `docs/REPO_INVENTORY.md` | docs | non_production | keep | - | - |
| `docs/SYMBOL_MAP.json` | docs | non_production | keep | - | - |
| `docs/SYMBOL_MAP.md` | docs | non_production | keep | - | - |
| `docs/VALIDATION_REPORT_TEMPLATE.md` | docs | non_production | keep | - | - |
| `docs/archive/NEXT_STEPS.md` | docs | non_production | review_for_archive | archive | - |
| `docs/archive/PROJECT_STATUS.md` | docs | non_production | review_for_archive | archive | - |
| `docs/archive/README.md` | docs | non_production | keep | - | - |
...
| `src/universal_visual_os_agent/actions/safe_click.py` | actions | supporting | review_for_cycle_isolation | - | cycle_member, oversized_module, high_internal_import_count:10, high_cross_package_import_count:5 |
| `src/universal_visual_os_agent/actions/scaffolding.py` | actions | supporting | review_for_split | - | oversized_module |
| `src/universal_visual_os_agent/actions/scaffolding_models.py` | actions | supporting | keep | - | - |
| `src/universal_visual_os_agent/ai_architecture/__init__.py` | ai_contracts | supporting | keep | - | facade_reexport_surface |
| `src/universal_visual_os_agent/ai_architecture/arbitration.py` | ai_contracts | supporting | review_for_split | - | oversized_module |
| `src/universal_visual_os_agent/ai_architecture/cloud_planner.py` | ai_contracts | supporting | review_for_split | - | oversized_module, high_internal_import_count:12, high_cross_package_import_count:6 |
| `src/universal_visual_os_agent/ai_architecture/contracts.py` | ai_contracts | supporting | review_for_split | - | oversized_module, high_cross_package_import_count:5 |
| `src/universal_visual_os_agent/ai_architecture/escalation_engine.py` | ai_contracts | supporting | review_for_split | - | oversized_module |
| `src/universal_visual_os_agent/ai_architecture/interfaces.py` | ai_contracts | supporting | keep | - | high_internal_import_count:12, high_cross_package_import_count:6 |
| `src/universal_visual_os_agent/ai_architecture/local_visual_resolver.py` | ai_contracts | supporting | review_for_split | - | oversized_module |
| `src/universal_visual_os_agent/ai_architecture/ontology.py` | ai_contracts | supporting | review_for_split | - | oversized_module |
...
| `tests/test_cloud_planner_scaffolding.py` | test_only | non_production | retain_as_test_only | - | - |
| `tests/test_config_models.py` | test_only | non_production | retain_as_test_only | - | - |
| `tests/test_deterministic_escalation_engine.py` | test_only | non_production | retain_as_test_only | - | - |
...
| `tests/test_import_boundaries.py` | test_only | non_production | retain_as_test_only | - | - |
| `tests/test_local_visual_resolver_scaffolding.py` | test_only | non_production | retain_as_test_only | - | - |
